...
\begin{document}
	...
	\begin{frontmatter}
		...
		\author[label1]{Zhipeng Liu} % lzp990616@gmail.com
		\author[label1]{Yaotong Song} % 2712982457g@gmail.com
		\author[label2]{Junyan Yi} % yijunyan@bucea.edu.cn
		\author[label1]{Zhiming Zhang} % zhangzm0128@163.com
		\author[label1]{Masaaki Omura} % momura@eng.u-toyama.ac.jp
